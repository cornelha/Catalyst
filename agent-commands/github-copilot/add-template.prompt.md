---
agent: 'agent'
description: Add a new agent template to catalyst-templates/
---
Add a new agent template to catalyst-templates/ for this tool: ${input:toolName:Agent/tool name, e.g. windsurf}
...
DO NOT BUILD framework code. Build ONE markdown file only: catalyst-templates/${input:toolName}.md
