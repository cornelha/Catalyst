---
agent: 'agent'
description: Review session lessons and turn them into new or updated catalyst skills
---
...
Optional focus: ${input:focus:Optional topic/area to limit the review to (leave blank to review the whole session)}
