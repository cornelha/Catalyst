...
description: Research-only architecture explanation using diamond pattern - no edits, mermaid/tables output
---
...
Question: ${input:question:What do you want explained?}

If ${input:question:What do you want explained?} is empty, ask the user what they want explained.
