...
Steps:
1. Read `catalyst-templates/codex.md` and find the "Instruction Text to Paste" section. Copy the content *inside* the ```markdown fence (not the fence itself).
...
(the Instruction Text to Paste content you copied from catalyst-templates/codex.md goes here)
```
