...
PHASE 1 — FAN OUT
State the independent analysis tasks you'll run. List them before running them. Then actually run them (search the codebase, read files, check git history, etc.) — issued together in as few turns as possible, not interleaved with analysis.
