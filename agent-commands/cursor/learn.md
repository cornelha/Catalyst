...
Optional focus: treat whatever text was typed after `/learn` when this command was invoked as the topic, ticket type, or area of the repo to limit the review to; if nothing was typed, review the whole session.
