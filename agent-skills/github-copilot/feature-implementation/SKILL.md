...
metadata:
  source: .catalyst/skills/feature-implementation.md
---
...
If the ticket is about restoring previously-working behavior, use `bug-fix` instead. If it's about improving existing code without changing behavior, this skill doesn't apply (no ticket type currently covers pure refactors in this library).
