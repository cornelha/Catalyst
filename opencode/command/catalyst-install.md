...
3. Read the project's `AGENTS.md` (create it if it doesn't exist). If you prefer a global install, use `~/.config/opencode/AGENTS.md` instead — ask the user which they want if it's not obvious.
