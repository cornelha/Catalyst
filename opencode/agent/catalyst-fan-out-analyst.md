---
description: Runs one independent, read-only analysis task and returns a structured finding list. Invoked once per FAN OUT task by the orchestrator via the Task tool.
mode: subagent
