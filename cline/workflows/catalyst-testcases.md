Generate test cases from a ticket's acceptance criteria, in the tracker's native format.

Ticket: use whatever text the user included in the same chat message as `/catalyst-testcases.md` as the ticket reference, URL, or pasted description to work.
