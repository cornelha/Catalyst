...
Optional focus: use whatever text the user included in the same chat message as `/learn.md` as the topic, ticket type, or area of the repo to limit the review to; if none, review the whole session.
